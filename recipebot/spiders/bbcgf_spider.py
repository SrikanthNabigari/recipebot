...
class RecipeLink(scrapy.Spider):
    ...
    def parseCategory(self,response):
        ...
        item['ingredients'] = sel.xpath('//li[@class="ingredient-list__item"]/a/text()').extract()
        ...
        nutri_label = sel.xpath('//span[@class="nutrition__label nutrition__label--low"]/text()').extract()
